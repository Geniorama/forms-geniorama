// ============================================================
//  GENIORAMA — Brief Landing Page
//  brief-landing.js  |  ES6+
// ============================================================

const STORAGE_KEY = 'geniorama_brief_landing_v1';
const TOTAL_STEPS  = 8;
...
const LABELS = {
  ...
  lead_gen:      'Generar leads',
  venta:         'Vender un producto o servicio',
  lanzamiento:   'Lanzar un producto o promoción',
  evento:        'Inscripción a evento / webinar',
  descarga:      'Descargar app o recurso',
  suscripcion:   'Captar suscriptores / lista de espera',
  agendar:       'Agendar cita o demo',
  validacion:    'Validar una idea o MVP',
  objetivo_otro: 'Otro',
  // Tipo de landing
  captura_leads: 'Captura de leads',
  ventas:        'Página de ventas (sales page)',
  click_through: 'Click-through',
  coming_soon:   'Coming soon / Lista de espera',
  tipo_otro:     'No estoy seguro',
  // Fases / servicios
  estrategia:    'Estrategia de conversión',
  copywriting:   'Copywriting persuasivo',
  disenio:       'Diseño UX/UI',
  desarrollo:    'Desarrollo / maquetación',
  contenido:     'Contenido: foto / video',
  animaciones:   'Animaciones e interacciones',
  integraciones: 'Integraciones de marketing',
  despliegue:    'Hosting, dominio y publicación',
  seo:           'SEO y velocidad',
  optimizacion:  'Optimización post-lanzamiento (CRO)',
  mantenimiento: 'Mantenimiento y soporte',
  // Plataforma / tecnología
  plat_codigo:    'Código a medida',
  plat_wordpress: 'WordPress / Elementor',
  plat_webflow:   'Webflow',
  plat_framer:    'Framer',
  plat_nose:      'Sin preferencia',
  // Longitud
  corta: 'Corta (1 sección)',
  media: 'Media (4 – 7 secciones)',
  larga: 'Larga (8+ secciones)',
  // Secciones
  sec_hero:         'Hero principal',
  sec_beneficios:   'Beneficios / características',
  sec_comofunciona: 'Cómo funciona / pasos',
  sec_testimonios:  'Testimonios / prueba social',
  sec_galeria:      'Galería / portafolio',
  sec_precios:      'Precios / planes',
  sec_faq:          'Preguntas frecuentes (FAQ)',
  sec_formulario:   'Formulario de contacto / registro',
  sec_video:        'Video / VSL',
  sec_countdown:    'Contador regresivo',
  sec_mapa:         'Mapa / ubicación',
  sec_equipo:       'Equipo / sobre nosotros',
  // Integraciones
  int_email:      'Email marketing',
  int_crm:        'CRM',
  int_pixels:     'Píxeles de seguimiento',
  int_analytics:  'Analítica (GA4, Tag Manager)',
  int_pagos:      'Pasarela de pago',
  int_calendario: 'Agendamiento (Calendly)',
  int_whatsapp:   'Botón / chat de WhatsApp',
  int_chatbot:    'Chatbot',
  int_abtest:     'Pruebas A/B',
  int_popup:      'Pop-up / exit intent',
  // Idiomas
  lang_es:   'Español',
  lang_en:   'Inglés',
  lang_pt:   'Portugués',
  ...
  '3000-6000': '$3,000 – $6,000 USD',
  'mas-6000':  'Más de $6,000 USD',
...
function bindConditionals() {
  document.addEventListener('field:change', ({ detail }) => {
    if (detail.field === 'tieneSitio') {
      toggleConditional('url-actual-group', detail.value === 'si' || detail.value === 'dominio');
    }
...
function restoreConditionals() {
  setTimeout(() => {
    toggleConditional('url-actual-group', state.data.tieneSitio === 'si' || state.data.tieneSitio === 'dominio');
...
function renderSummary() {
  ...
  const tieneSitioLabel = d.tieneSitio === 'si' ? 'Sí, tiene sitio / landing previa'
                        : d.tieneSitio === 'no' ? 'No'
                        : d.tieneSitio === 'dominio' ? 'Solo el dominio'
                        : null;
  ...
  const sections = [
    ...
    },
    {
      title: '02 · La landing',
      rows: [
        { l: 'Nombre / campaña',       v: d.proyectoNombre },
        { l: '¿Tiene sitio previo?',   v: tieneSitioLabel },
        { l: 'Enlace / dominio',       v: (d.tieneSitio === 'si' || d.tieneSitio === 'dominio') ? d.urlActual : null },
        { l: 'Qué promociona',         v: d.descripcion },
        { l: 'Audiencia',              v: d.audiencia },
        { l: 'Objetivo de conversión', v: label(d.objetivo) },
        { l: 'Origen del tráfico',     v: d.trafico },
      ],
    },
    {
      title: '03 · Tipo de landing',
      rows: [{ l: 'Tipo seleccionado', v: label(d.tipoLanding) }],
    },
    {
      title: '04 · Servicios',
      rows: [{ l: 'Servicios requeridos', v: label(d.fases) }],
    },
    {
      title: '05 · Estructura y funciones',
      rows: [
        { l: 'Tecnología',     v: label(d.plataforma) },
        { l: 'Extensión',      v: label(d.longitud) },
        { l: 'Secciones',      v: label(d.secciones) },
        { l: 'Integraciones',  v: label(d.integraciones) },
    ...
    },
    {
      ...
      rows: [
        ...
        { l: '¿Tiene el contenido?',     v: d.tieneContenido === 'si' ? 'Sí, todo listo' : d.tieneContenido === 'parcial' ? 'Parcial' : d.tieneContenido === 'no' ? 'No, lo necesita todo' : null },
...
function downloadJSON() {
  ...
  a.href     = url;
  a.download = `brief-landing-${(state.data.empresa || 'cliente').replace(/\s+/g, '-').toLowerCase()}-${Date.now()}.json`;
